...
public class Product implements Serializable {
    ...
    public Product(Integer id, String title, Double marketPrice, Double shopPrice, String image, String desc, Integer isHot, Integer csid, Date pdate,String propertyDesc, Integer quantity) {
        this.id = id;
        this.title = title;
